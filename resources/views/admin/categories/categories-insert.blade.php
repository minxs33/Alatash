...
@section('title','Alatash - Tambah Kategori')
...
<form class="border border-light px-4 py-3 row" action="{{ url('admin/categories') }}" method="POST">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-2">
        <h3 class="h3 mb-0 text-base fw-bold">Tambah Kategori</h3>
    </div>
    <hr>
    ...
    <div class="mb-4">
        <div class="d-flex gap-2 align-text-center">
            <label class="form-label" for="textAreaExample">Kategori<span class="text-danger">*</span>
            </label>
            @if($errors->has('name'))
