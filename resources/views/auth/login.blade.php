...
<head>
    ...
    <title>Altash Admin - Login</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-aFq/bzH65dt+w6FI2ooMVUpc+21e0SRygnTpmBvdBgSdnuTN7QbdgL+OapgHtvPp" crossorigin="anonymous">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.4.0/css/all.min.css" integrity="sha512-iecdLmaskl7CVkqkXNQ/ZH/XLlvWZOJyj7Yy7tcenmpD1ypASozpmT/E0iPtmFIB46ZmdtAc9eNBvH0H/ZpiBw==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    <link rel="shortcut icon" href="{{ asset('images/logo_alatash_3_warnaa-01.png.png') }}" type="image/x-icon">
            ...
            <div class="card p-4 d-flex d-column justify-content-center">
                ...
                <div class="mb-4">
                    ...
                    <div class="input-group">
                        <input autocomplete="$_COOKIE" type="password" class="form-control border-end-0" id="password" name="password" placeholder="password">
                ...
                <div class="d-flex align-items-center justify-content-end mb-3">
                    <div class="d-flex gap-1 align-items-center">
                        <button class="btn btn-sm primary-color text-white px-3" type="submit">
                            Next
                        </button>
                    </div>
                </div>
